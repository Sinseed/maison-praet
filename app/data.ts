...
La commission de courtage est généralement calculée en pourcentage du prix de vente, plus TVA. Elle varie selon le type de bien, le mandat et le niveau de service. Point important : la commission est intégralement déductible de l'impôt sur le gain immobilier. Ce n'est donc pas une charge sèche.
...
Ma méthode : je préfère perdre un mandat en donnant un prix honnête que de le gagner avec un prix irréaliste. Si mon estimation ne vous convient pas, je vous le dis et je vous laisse le choix. Mais je ne vous ferai pas perdre six mois.`,
  ...
  },
  {
    ...
    chapeau: "Mandat exclusif ou non-exclusif ? Commission fixe ou au pourcentage ? Au-delà de la technique, la vraie question : ce courtier va-t-il se battre pour défendre votre prix ?",
    date: '2026-03-10',
    categorie: 'Guide pratique',
...
La question centrale : est-ce qu'il va se battre pour moi ? Un bon courtier ne se contente pas de publier une annonce et d'attendre les appels. Il négocie. Il tient le prix. Il filtre les offres opportunistes et sait dire non à un acquéreur qui tente sa chance 15% en dessous. Quand une offre arrive, il l'analyse, la contextualise, et vous conseille avec franchise. Demandez-lui : comment gérez-vous une négociation difficile ? Sa réponse en dit plus que n'importe quelle brochure.

La connaissance du marché local est non négociable. Un courtier qui travaille entre Genève et Zurich ne connaît pas le prix au m² à Cossonay. Demandez des références de ventes récentes dans votre commune ou votre quartier. Un bon courtier les a en tête. Il connaît les acquéreurs actifs, les notaires du coin, les délais réels. C'est cette connaissance fine qui lui permet de défendre votre prix avec des arguments concrets.

La méthode d'estimation doit être transparente. Fuyez les courtiers qui vous donnent un prix "au feeling" ou après une visite de 15 minutes. Une estimation sérieuse prend du temps : analyse du terrain, de la construction, des transactions comparables, du potentiel de rendement. Demandez un rapport écrit. Un courtier qui surestime votre bien pour décrocher le mandat ne vous rend pas service. Il vous fera perdre du temps, puis proposera des baisses de prix successives.

Le mandat exclusif n'est pas un piège. Beaucoup de vendeurs hésitent par peur d'être "coincés". En réalité, un mandat exclusif aligne les intérêts : le courtier investit pleinement dans la vente parce qu'il sait que son travail sera rémunéré. Il s'engage. Un mandat non-exclusif confié à trois courtiers donne souvent trois annonces différentes avec trois prix différents. L'acquéreur ne sait plus à qui s'adresser. Le bien perd en crédibilité, et c'est votre prix qui en souffre.

La commission, fixe ou au pourcentage, reflète un engagement. Ce qui compte, ce n'est pas le taux. C'est ce que le courtier met en face. Est-ce qu'il investit dans une présentation à la hauteur du bien ? Est-ce qu'il vous accompagne jusqu'à la signature chez le notaire ? Et surtout : est-ce qu'il est capable de justifier chaque franc de votre prix face à un acquéreur qui négocie ? N'oubliez pas que la commission est intégralement déductible de l'impôt sur le gain immobilier.
...
Mon conseil : rencontrez au moins deux courtiers avant de choisir. Posez-leur les mêmes questions et comparez les réponses. Le meilleur courtier n'est pas celui qui vous promet le prix le plus élevé. C'est celui qui vous donne confiance qu'il défendra ce prix jusqu'au bout.`,
