...
export type Mandat = {
  ...
  videoDate?: string   // Date de publication du teaser, format YYYY-MM-DD (requis par Google pour VideoObject)
}
...
export const MANDATS: Mandat[] = [
  ...
  },
  {
    ...
    video: '/videos/maison-yverdon.mp4',
    videoPoster: '/videos/maison-yverdon-poster.jpg',
    videoDate: '2026-08-20',
...
L'immobilier locatif dans le canton de Vaud reste une stratégie patrimoniale solide. La demande locative ne faiblit pas, l'offre reste insuffisante dans les zones urbaines, et le franc suisse protège la valeur réelle des actifs. Mais un bon investissement ne se trouve pas sur une annonce. Il se construit sur [une analyse précise du bien](/journal/estimer-son-bien-canton-de-vaud), de son emplacement, de son financement et de sa fiscalité.`,
  ...
  },
  {
    ...
    chapeau: "La grande majorité des ventes immobilières vaudoises se signent des mois avant la remise des clés. Ce mécanisme, la vente à terme, protège très efficacement les deux parties, à condition d'en comprendre les rouages. Voici ce qui se passe réellement entre la signature et le transfert.",
    date: '2026-07-08',
    categorie: 'Juridique',
    contenu: `## Signer aujourd'hui, transférer plus tard

Dans le canton de Vaud, il est rare qu'un vendeur remette ses clés le jour où il signe chez le notaire. Dans l'immense majorité des dossiers que je traite, l'acte notarié est signé plusieurs mois avant le transfert de propriété. C'est le principe de la vente à terme : les parties s'engagent définitivement aujourd'hui, et la vente s'exécute à une date convenue, le terme.

Attention à une confusion fréquente : la vente à terme n'est pas un avant-contrat, une réservation ou une promesse de vente. C'est un contrat de vente complet, en la forme authentique exigée par l'article 216 du Code des obligations, qui contient tous les éléments de la transaction : prix, date de transfert, répartition des frais, état du bien. Une fois signé, aucune des deux parties ne peut simplement changer d'avis. La seule chose qui est différée, c'est l'inscription au registre foncier, qui marque juridiquement le changement de propriétaire.
...
Un point que les vendeurs ignorent souvent : dans de nombreux dossiers, le notaire peut leur libérer cet acompte peu après la signature, dès qu'il s'est assuré de pouvoir solder les dettes hypothécaires grevant l'immeuble au moment du transfert. Cela peut faciliter le financement d'un nouveau projet sans attendre le terme.
