    ...
    <section className="relative min-h-screen overflow-hidden bg-brand-dark">
      ...
      <div className="relative z-20 min-h-screen flex flex-col pt-28 pb-12 md:pt-48 md:pb-20 max-w-7xl mx-auto px-6">
        <div className="max-w-2xl mt-auto md:my-auto">
          ...
          <h1 style={{fontSize: 'clamp(2.2rem, 10vw, 9rem)', animationDelay: '0.32s'}} className="hero-in font-display font-light italic text-brand-gold leading-[0.95] mb-8 md:mb-10">
            Praet
          </h1>

          <p className="hero-in font-body text-lg md:text-xl text-brand-text leading-relaxed mb-3 max-w-lg" style={{animationDelay: '0.46s'}}>
          ...
          {/* Killer stat */}
          <div className="hero-in flex items-end gap-4" style={{animationDelay: '0.8s'}}>
            <p className="font-display text-5xl md:text-6xl font-light text-brand-gold leading-none"><AnimatedNumber value={96.8} decimals={1} /><span className="text-3xl">%</span></p>
...
function StatsBar() {
  return (
    <section className="border-y border-brand-border">
      <Reveal className="max-w-7xl mx-auto px-6 py-10 grid grid-cols-2 md:grid-cols-3 gap-8 md:gap-4">
        <div className="text-center">
          <p className="font-display text-3xl md:text-4xl font-light text-brand-gold"><AnimatedNumber value={6} />+</p>
    ...
    <footer className="max-w-7xl mx-auto px-6 py-12">
      <div className="flex flex-col sm:flex-row items-center justify-between gap-6 pb-8 border-b border-brand-border">
        ...
        <a href="https://www.golay-immobilier.ch" target="_blank" rel="noopener noreferrer" className="group flex items-center gap-3">
          ...
          <img src="/golay-icon.svg" alt="Golay Immobilier" width={22} height={22} className="opacity-90" />
          <span className="font-body text-sm text-brand-text group-hover:text-brand-gold transition-colors">Golay Immobilier</span>
        </a>
      </div>
      <div className="flex flex-col sm:flex-row items-center justify-between gap-2 sm:gap-6 pt-6">
        <p className="font-body text-xs text-brand-muted tracking-wider">© {new Date().getFullYear()} Thomas Praet · Golay Immobilier · Lausanne</p>
...
function Testimonials() {
  ...
  return (
    <section className="py-24 bg-brand-dark relative overflow-hidden">
      ...
      <div className="marquee-mask marquee-pause relative z-10 overflow-hidden">
            ...
            <div key={copy} className="flex gap-6 pr-6 shrink-0" aria-hidden={copy === 1}>
              {TEMOIGNAGES.map((t, i) => (
                <figure key={i} className="card-luxe w-[300px] sm:w-[380px] shrink-0 flex flex-col bg-brand-card/50 border border-brand-border/50 p-8 hover:border-brand-gold/30 transition-colors duration-500">
                  ...
                  <blockquote className="font-body text-brand-text text-[15px] leading-relaxed mb-8 italic line-clamp-6">&ldquo;{t.texte}&rdquo;</blockquote>
